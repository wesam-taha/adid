...
class cactivities_add extends cactivities {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["activity_id"] != "") {
				...
				$this->setKey("activity_id", $this->activity_id->CurrentValue); // Set up key
			} else {
				$this->setKey("activity_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "activitiesview.php")
	...
	function LoadDefaultValues() {
		$this->activity_name_ar->CurrentValue = NULL;
		$this->activity_name_ar->OldValue = $this->activity_name_ar->CurrentValue;
		$this->activity_name_en->CurrentValue = NULL;
		$this->activity_name_en->OldValue = $this->activity_name_en->CurrentValue;
		...
		$this->activity_time_ar->CurrentValue = NULL;
		$this->activity_time_ar->OldValue = $this->activity_time_ar->CurrentValue;
		$this->activity_time_en->CurrentValue = NULL;
		$this->activity_time_en->OldValue = $this->activity_time_en->CurrentValue;
		$this->activity_description_ar->CurrentValue = NULL;
		$this->activity_description_ar->OldValue = $this->activity_description_ar->CurrentValue;
		$this->activity_description_en->CurrentValue = NULL;
		$this->activity_description_en->OldValue = $this->activity_description_en->CurrentValue;
		$this->activity_persons->CurrentValue = NULL;
		$this->activity_persons->OldValue = $this->activity_persons->CurrentValue;
		$this->activity_hours->CurrentValue = NULL;
		$this->activity_hours->OldValue = $this->activity_hours->CurrentValue;
		$this->activity_city->CurrentValue = NULL;
		$this->activity_city->OldValue = $this->activity_city->CurrentValue;
		$this->activity_location_ar->CurrentValue = NULL;
		$this->activity_location_ar->OldValue = $this->activity_location_ar->CurrentValue;
		$this->activity_location_en->CurrentValue = NULL;
		$this->activity_location_en->OldValue = $this->activity_location_en->CurrentValue;
		$this->activity_location_map->CurrentValue = NULL;
		$this->activity_location_map->OldValue = $this->activity_location_map->CurrentValue;
		$this->activity_image->Upload->DbValue = NULL;
		$this->activity_image->OldValue = $this->activity_image->Upload->DbValue;
		$this->activity_image->CurrentValue = NULL; // Clear file related field
		$this->activity_organizer_ar->CurrentValue = NULL;
		$this->activity_organizer_ar->OldValue = $this->activity_organizer_ar->CurrentValue;
		$this->activity_organizer_en->CurrentValue = NULL;
		$this->activity_organizer_en->OldValue = $this->activity_organizer_en->CurrentValue;
		$this->activity_category_ar->CurrentValue = NULL;
		$this->activity_category_ar->OldValue = $this->activity_category_ar->CurrentValue;
		$this->activity_category_en->CurrentValue = NULL;
		$this->activity_category_en->OldValue = $this->activity_category_en->CurrentValue;
		$this->activity_type->CurrentValue = NULL;
		$this->activity_type->OldValue = $this->activity_type->CurrentValue;
		...
		$this->activity_terms_and_conditions_ar->CurrentValue = NULL;
		$this->activity_terms_and_conditions_ar->OldValue = $this->activity_terms_and_conditions_ar->CurrentValue;
		$this->activity_terms_and_conditions_en->CurrentValue = NULL;
		$this->activity_terms_and_conditions_en->OldValue = $this->activity_terms_and_conditions_en->CurrentValue;
		$this->activity_active->CurrentValue = NULL;
		$this->activity_active->OldValue = $this->activity_active->CurrentValue;
		$this->leader_username->CurrentValue = NULL;
		$this->leader_username->OldValue = $this->leader_username->CurrentValue;
	}
	...
	function RenderRow() {
		...
		$this->leader_username->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->activity_image);
	...
	function ValidateForm() {
		...
		if (in_array("registered_users", $DetailTblVar) && $GLOBALS["registered_users"]->DetailAdd) {
	...
	function AddRow($rsold = NULL) {
		...
		// activity_name_ar
		$this->activity_name_ar->SetDbValueDef($rsnew, $this->activity_name_ar->CurrentValue, NULL, FALSE);

		// activity_name_en
		$this->activity_name_en->SetDbValueDef($rsnew, $this->activity_name_en->CurrentValue, NULL, FALSE);
		...
		// activity_time_ar
		$this->activity_time_ar->SetDbValueDef($rsnew, $this->activity_time_ar->CurrentValue, NULL, FALSE);

		// activity_time_en
		$this->activity_time_en->SetDbValueDef($rsnew, $this->activity_time_en->CurrentValue, NULL, FALSE);

		// activity_description_ar
		$this->activity_description_ar->SetDbValueDef($rsnew, $this->activity_description_ar->CurrentValue, NULL, FALSE);

		// activity_description_en
		$this->activity_description_en->SetDbValueDef($rsnew, $this->activity_description_en->CurrentValue, NULL, FALSE);

		// activity_persons
		$this->activity_persons->SetDbValueDef($rsnew, $this->activity_persons->CurrentValue, NULL, FALSE);

		// activity_hours
		$this->activity_hours->SetDbValueDef($rsnew, $this->activity_hours->CurrentValue, NULL, FALSE);

		// activity_city
		$this->activity_city->SetDbValueDef($rsnew, $this->activity_city->CurrentValue, NULL, FALSE);

		// activity_location_ar
		$this->activity_location_ar->SetDbValueDef($rsnew, $this->activity_location_ar->CurrentValue, NULL, FALSE);

		// activity_location_en
		$this->activity_location_en->SetDbValueDef($rsnew, $this->activity_location_en->CurrentValue, NULL, FALSE);

		// activity_location_map
		$this->activity_location_map->SetDbValueDef($rsnew, $this->activity_location_map->CurrentValue, NULL, FALSE);

		// activity_image
		if ($this->activity_image->Visible && !$this->activity_image->Upload->KeepFile) {
			$this->activity_image->Upload->DbValue = ""; // No need to delete old file
		...
		// activity_organizer_ar
		$this->activity_organizer_ar->SetDbValueDef($rsnew, $this->activity_organizer_ar->CurrentValue, NULL, FALSE);

		// activity_organizer_en
		$this->activity_organizer_en->SetDbValueDef($rsnew, $this->activity_organizer_en->CurrentValue, NULL, FALSE);

		// activity_category_ar
		$this->activity_category_ar->SetDbValueDef($rsnew, $this->activity_category_ar->CurrentValue, NULL, FALSE);

		// activity_category_en
		$this->activity_category_en->SetDbValueDef($rsnew, $this->activity_category_en->CurrentValue, NULL, FALSE);

		// activity_type
		$this->activity_type->SetDbValueDef($rsnew, $this->activity_type->CurrentValue, NULL, FALSE);

		// activity_gender_target
		$this->activity_gender_target->SetDbValueDef($rsnew, $this->activity_gender_target->CurrentValue, NULL, FALSE);

		// activity_terms_and_conditions_ar
		$this->activity_terms_and_conditions_ar->SetDbValueDef($rsnew, $this->activity_terms_and_conditions_ar->CurrentValue, NULL, FALSE);

		// activity_terms_and_conditions_en
		$this->activity_terms_and_conditions_en->SetDbValueDef($rsnew, $this->activity_terms_and_conditions_en->CurrentValue, NULL, FALSE);

		// activity_active
		$this->activity_active->SetDbValueDef($rsnew, $this->activity_active->CurrentValue, NULL, FALSE);

		// leader_username
		$this->leader_username->SetDbValueDef($rsnew, $this->leader_username->CurrentValue, NULL, FALSE);
		if ($this->activity_image->Visible && !$this->activity_image->Upload->KeepFile) {
			$this->activity_image->UploadPath = "../images";
		...
		if ($AddRow) {
			$DetailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("registered_users", $DetailTblVar) && $GLOBALS["registered_users"]->DetailAdd) {
				$GLOBALS["registered_users"]->activity_id->setSessionValue($this->activity_id->CurrentValue); // Set master key
				if (!isset($GLOBALS["registered_users_grid"])) $GLOBALS["registered_users_grid"] = new cregistered_users_grid(); // Get detail page object
				$Security->LoadCurrentUserLevel($this->ProjectID . "registered_users"); // Load user level of detail table
				$AddRow = $GLOBALS["registered_users_grid"]->GridInsert();
				$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$AddRow)
					$GLOBALS["registered_users"]->activity_id->setSessionValue(""); // Clear master key if insert failed
			}
		}
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("registered_users", $DetailTblVar)) {
				...
				if ($GLOBALS["registered_users_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["registered_users_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["registered_users_grid"]->CurrentMode = "add";
					$GLOBALS["registered_users_grid"]->CurrentAction = "gridadd";
...
factivitiesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
factivitiesadd.Lists["x_activity_city"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
factivitiesadd.Lists["x_activity_city"].Options = <?php echo json_encode($activities_add->activity_city->Options()) ?>;
factivitiesadd.Lists["x_activity_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
factivitiesadd.Lists["x_activity_type"].Options = <?php echo json_encode($activities_add->activity_type->Options()) ?>;
factivitiesadd.Lists["x_activity_gender_target"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
factivitiesadd.Lists["x_activity_gender_target"].Options = <?php echo json_encode($activities_add->activity_gender_target->Options()) ?>;
factivitiesadd.Lists["x_activity_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
factivitiesadd.Lists["x_activity_active"].Options = <?php echo json_encode($activities_add->activity_active->Options()) ?>;
factivitiesadd.Lists["x_leader_username"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_full_name_ar","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
factivitiesadd.Lists["x_leader_username"].Data = "<?php echo $activities_add->leader_username->LookupFilterQuery(FALSE, "add") ?>";
factivitiesadd.AutoSuggests["x_leader_username"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $activities_add->leader_username->LookupFilterQuery(TRUE, "add"))) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($activities_add->IsModal) ?>">
<?php if (!$activities_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($activities_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_activitiesadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($activities->activity_name_ar->Visible) { // activity_name_ar ?>
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_name_ar" class="form-group">
		<label id="elh_activities_activity_name_ar" for="x_activity_name_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_name_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_name_ar->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_name_en" class="form-group">
		<label id="elh_activities_activity_name_en" for="x_activity_name_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_name_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_name_en->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_start_date" class="form-group">
		<label id="elh_activities_activity_start_date" for="x_activity_start_date" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_start_date->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_start_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("factivitiesadd", "x_activity_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_end_date" class="form-group">
		<label id="elh_activities_activity_end_date" for="x_activity_end_date" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_end_date->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_end_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("factivitiesadd", "x_activity_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_time_ar" class="form-group">
		<label id="elh_activities_activity_time_ar" for="x_activity_time_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_time_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_time_ar->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_time_en" class="form-group">
		<label id="elh_activities_activity_time_en" for="x_activity_time_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_time_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_time_en->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_description_ar" class="form-group">
		<label id="elh_activities_activity_description_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_description_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_description_ar->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("factivitiesadd", "x_activity_description_ar", 35, 4, <?php echo ($activities->activity_description_ar->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_description_en" class="form-group">
		<label id="elh_activities_activity_description_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_description_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_description_en->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("factivitiesadd", "x_activity_description_en", 35, 4, <?php echo ($activities->activity_description_en->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_persons" class="form-group">
		<label id="elh_activities_activity_persons" for="x_activity_persons" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_persons->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_persons->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_hours" class="form-group">
		<label id="elh_activities_activity_hours" for="x_activity_hours" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_hours->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_hours->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_city" class="form-group">
		<label id="elh_activities_activity_city" for="x_activity_city" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_city->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_city->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_location_ar" class="form-group">
		<label id="elh_activities_activity_location_ar" for="x_activity_location_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_location_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_location_ar->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_location_en" class="form-group">
		<label id="elh_activities_activity_location_en" for="x_activity_location_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_location_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_location_en->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_location_map" class="form-group">
		<label id="elh_activities_activity_location_map" for="x_activity_location_map" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_location_map->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_location_map->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_image" class="form-group">
		<label id="elh_activities_activity_image" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_image->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_image->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_organizer_ar" class="form-group">
		<label id="elh_activities_activity_organizer_ar" for="x_activity_organizer_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_organizer_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_organizer_ar->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_organizer_en" class="form-group">
		<label id="elh_activities_activity_organizer_en" for="x_activity_organizer_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_organizer_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_organizer_en->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_category_ar" class="form-group">
		<label id="elh_activities_activity_category_ar" for="x_activity_category_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_category_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_category_ar->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_category_en" class="form-group">
		<label id="elh_activities_activity_category_en" for="x_activity_category_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_category_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_category_en->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_type" class="form-group">
		<label id="elh_activities_activity_type" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_type->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_type->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_gender_target" class="form-group">
		<label id="elh_activities_activity_gender_target" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_gender_target->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_gender_target->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_terms_and_conditions_ar" class="form-group">
		<label id="elh_activities_activity_terms_and_conditions_ar" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_terms_and_conditions_ar->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_terms_and_conditions_ar->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("factivitiesadd", "x_activity_terms_and_conditions_ar", 35, 4, <?php echo ($activities->activity_terms_and_conditions_ar->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_terms_and_conditions_en" class="form-group">
		<label id="elh_activities_activity_terms_and_conditions_en" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_terms_and_conditions_en->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_terms_and_conditions_en->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("factivitiesadd", "x_activity_terms_and_conditions_en", 35, 4, <?php echo ($activities->activity_terms_and_conditions_en->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_activity_active" class="form-group">
		<label id="elh_activities_activity_active" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->activity_active->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->activity_active->CellAttributes() ?>>
...
<?php if ($activities_add->IsMobileOrModal) { ?>
	<div id="r_leader_username" class="form-group">
		<label id="elh_activities_leader_username" class="<?php echo $activities_add->LeftColumnClass ?>"><?php echo $activities->leader_username->FldCaption() ?></label>
		<div class="<?php echo $activities_add->RightColumnClass ?>"><div<?php echo $activities->leader_username->CellAttributes() ?>>
...
<script type="text/javascript">
factivitiesadd.CreateAutoSuggest({"id":"x_leader_username","forceSelect":false});
</script>
...
<?php } ?>
<?php
	if (in_array("registered_users", explode(",", $activities->getCurrentDetailTable())) && $registered_users->DetailAdd) {
?>
...
<?php } ?>
<?php if (!$activities_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $activities_add->OffsetColumnClass ?>"><!-- buttons offset -->
