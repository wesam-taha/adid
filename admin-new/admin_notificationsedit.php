...
$admin_notifications_edit = NULL; // Initialize page object first

class cadmin_notifications_edit extends cadmin_notifications {
	...
	// Page object name
	var $PageObjName = 'admin_notifications_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("admin_notificationslist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// institution
			$this->institution->SetDbValueDef($rsnew, $this->institution->CurrentValue, NULL, $this->institution->ReadOnly);
			...
			// message_ar
			$this->message_ar->SetDbValueDef($rsnew, $this->message_ar->CurrentValue, NULL, $this->message_ar->ReadOnly);

			// title_en
			$this->title_en->SetDbValueDef($rsnew, $this->title_en->CurrentValue, NULL, $this->title_en->ReadOnly);

			// message_en
			$this->message_en->SetDbValueDef($rsnew, $this->message_en->CurrentValue, NULL, $this->message_en->ReadOnly);
...
// Create page object
if (!isset($admin_notifications_edit)) $admin_notifications_edit = new cadmin_notifications_edit();

// Page init
$admin_notifications_edit->Page_Init();

// Page main
$admin_notifications_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$admin_notifications_edit->Page_Render();
?>
...
var CurrentForm = fadmin_notificationsedit = new ew_Form("fadmin_notificationsedit", "edit");

// Validate form
fadmin_notificationsedit.Validate = function() {
...
fadmin_notificationsedit.Form_CustomValidate = 
...
fadmin_notificationsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fadmin_notificationsedit.Lists["x_institution[]"] = {"LinkField":"x_institution_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_institutes_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"institutions"};
fadmin_notificationsedit.Lists["x_institution[]"].Data = "<?php echo $admin_notifications_edit->institution->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $admin_notifications_edit->ShowPageHeader(); ?>
<?php
$admin_notifications_edit->ShowMessage();
?>
<form name="fadmin_notificationsedit" id="fadmin_notificationsedit" class="<?php echo $admin_notifications_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($admin_notifications_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $admin_notifications_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="admin_notifications">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($admin_notifications_edit->IsModal) ?>">
<?php if (!$admin_notifications_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_admin_notificationsedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($admin_notifications->id->Visible) { // id ?>
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_admin_notifications_id" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->id->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->id->CellAttributes() ?>>
<span id="el_admin_notifications_id">
<span<?php echo $admin_notifications->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $admin_notifications->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="admin_notifications" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($admin_notifications->id->CurrentValue) ?>">
<?php echo $admin_notifications->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_admin_notifications_id"><?php echo $admin_notifications->id->FldCaption() ?></span></td>
		<td<?php echo $admin_notifications->id->CellAttributes() ?>>
<span id="el_admin_notifications_id">
<span<?php echo $admin_notifications->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $admin_notifications->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="admin_notifications" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($admin_notifications->id->CurrentValue) ?>">
<?php echo $admin_notifications->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_user" class="form-group">
		<label id="elh_admin_notifications_user" for="x_user" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->user->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->user->CellAttributes() ?>>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_institution" class="form-group">
		<label id="elh_admin_notifications_institution" for="x_institution" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->institution->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->institution->CellAttributes() ?>>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_date" class="form-group">
		<label id="elh_admin_notifications_date" for="x_date" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->date->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fadmin_notificationsedit", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_title_ar" class="form-group">
		<label id="elh_admin_notifications_title_ar" for="x_title_ar" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->title_ar->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->title_ar->CellAttributes() ?>>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_message_ar" class="form-group">
		<label id="elh_admin_notifications_message_ar" for="x_message_ar" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->message_ar->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->message_ar->CellAttributes() ?>>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_title_en" class="form-group">
		<label id="elh_admin_notifications_title_en" for="x_title_en" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->title_en->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->title_en->CellAttributes() ?>>
...
<?php if ($admin_notifications_edit->IsMobileOrModal) { ?>
	<div id="r_message_en" class="form-group">
		<label id="elh_admin_notifications_message_en" for="x_message_en" class="<?php echo $admin_notifications_edit->LeftColumnClass ?>"><?php echo $admin_notifications->message_en->FldCaption() ?></label>
		<div class="<?php echo $admin_notifications_edit->RightColumnClass ?>"><div<?php echo $admin_notifications->message_en->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$admin_notifications_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $admin_notifications_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $admin_notifications_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fadmin_notificationsedit.Init();
</script>
<?php
$admin_notifications_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$admin_notifications_edit->Page_Terminate();
?>
