...
$admin_notifications_view = NULL; // Initialize page object first

class cadmin_notifications_view extends cadmin_notifications {
	...
	// Page object name
	var $PageObjName = 'admin_notifications_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "admin_notificationslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "admin_notificationslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "admin_notificationslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($admin_notifications_view)) $admin_notifications_view = new cadmin_notifications_view();

// Page init
$admin_notifications_view->Page_Init();

// Page main
$admin_notifications_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$admin_notifications_view->Page_Render();
?>
...
var CurrentForm = fadmin_notificationsview = new ew_Form("fadmin_notificationsview", "view");

// Form_CustomValidate event
fadmin_notificationsview.Form_CustomValidate = 
...
fadmin_notificationsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fadmin_notificationsview.Lists["x_institution[]"] = {"LinkField":"x_institution_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_institutes_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"institutions"};
fadmin_notificationsview.Lists["x_institution[]"].Data = "<?php echo $admin_notifications_view->institution->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($admin_notifications->Export == "") { ?>
<div class="ewToolbar">
<?php $admin_notifications_view->ExportOptions->Render("body") ?>
<?php
	foreach ($admin_notifications_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $admin_notifications_view->ShowPageHeader(); ?>
<?php
$admin_notifications_view->ShowMessage();
?>
<form name="fadmin_notificationsview" id="fadmin_notificationsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($admin_notifications_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $admin_notifications_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="admin_notifications">
<input type="hidden" name="modal" value="<?php echo intval($admin_notifications_view->IsModal) ?>">
...
<?php echo $admin_notifications->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $admin_notifications->user->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $admin_notifications->institution->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $admin_notifications->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $admin_notifications->title_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admin_notifications->message_ar->Visible) { // message_ar ?>
	<tr id="r_message_ar">
		<td class="col-sm-2"><span id="elh_admin_notifications_message_ar"><?php echo $admin_notifications->message_ar->FldCaption() ?></span></td>
		<td data-name="message_ar"<?php echo $admin_notifications->message_ar->CellAttributes() ?>>
<span id="el_admin_notifications_message_ar">
<span<?php echo $admin_notifications->message_ar->ViewAttributes() ?>>
<?php echo $admin_notifications->message_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $admin_notifications->title_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admin_notifications->message_en->Visible) { // message_en ?>
	<tr id="r_message_en">
		...
		<td data-name="message_en"<?php echo $admin_notifications->message_en->CellAttributes() ?>>
<span id="el_admin_notifications_message_en">
<span<?php echo $admin_notifications->message_en->ViewAttributes() ?>>
<?php echo $admin_notifications->message_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($admin_notifications->Export == "") { ?>
<script type="text/javascript">
fadmin_notificationsview.Init();
</script>
<?php } ?>
<?php
$admin_notifications_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($admin_notifications->Export == "") { ?>
...
<?php
$admin_notifications_view->Page_Terminate();
?>
