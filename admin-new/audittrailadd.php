...
<?php if (!$audittrail_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($audittrail_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_audittrailadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("faudittrailadd", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($audittrail_add->IsMobileOrModal) { ?>
	<div id="r__table" class="form-group">
		<label id="elh_audittrail__table" for="x__table" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->_table->FldCaption() ?></label>
...
<?php if ($audittrail_add->IsMobileOrModal) { ?>
	<div id="r__field" class="form-group">
		<label id="elh_audittrail__field" for="x__field" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->_field->FldCaption() ?></label>
		<div class="<?php echo $audittrail_add->RightColumnClass ?>"><div<?php echo $audittrail->_field->CellAttributes() ?>>
