...
<?php if (!$audittrail_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($audittrail_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_audittrailedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("faudittrailedit", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
	<tr id="r_datetime">
		<td class="col-sm-2"><span id="elh_audittrail_datetime"><?php echo $audittrail->datetime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php if ($audittrail_edit->IsMobileOrModal) { ?>
	<div id="r__table" class="form-group">
		<label id="elh_audittrail__table" for="x__table" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->_table->FldCaption() ?></label>
...
<?php if ($audittrail_edit->IsMobileOrModal) { ?>
	<div id="r__field" class="form-group">
		<label id="elh_audittrail__field" for="x__field" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->_field->FldCaption() ?></label>
		<div class="<?php echo $audittrail_edit->RightColumnClass ?>"><div<?php echo $audittrail->_field->CellAttributes() ?>>
