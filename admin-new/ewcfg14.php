...
define("EW_PROJECT_NAME", "adid", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{6A6E587E-A14E-4B9E-9243-D8812A8F089D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'irXfw7FpIFlz1Fjz', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/adid.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "adid", "qs" => "`", "qe" => "`");
...
// Check Token
define("EW_CHECK_TOKEN", false, false); // Check post token
...
define("EW_ADMIN_PASSWORD", "AdidAdmin!@#", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`management`", TRUE);
define("EW_USER_NAME_FILTER", "(`username` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`type` = %u)", TRUE);
...
// Email
define("EW_SMTP_SERVER", "mail.php-online.net", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 25, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "ssl", TRUE);
define("EW_SMTP_SERVER_USERNAME", "adid@php-online.net", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "Tweety!@#", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "adid@php-online.net", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "adid@php-online.net", TRUE); // Recipient email address
