...
$expired_institutions = NULL;

//
// Table class for expired_institutions
//
class cexpired_institutions extends cTable {
	var $institution_id;
	var $institutes_name;
	var $tl_expiry_date;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'expired_institutions';
		$this->TableName = 'expired_institutions';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`expired_institutions`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// institution_id
		$this->institution_id = new cField('expired_institutions', 'expired_institutions', 'x_institution_id', 'institution_id', '`institution_id`', '`institution_id`', 3, -1, FALSE, '`institution_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// institutes_name
		$this->institutes_name = new cField('expired_institutions', 'expired_institutions', 'x_institutes_name', 'institutes_name', '`institutes_name`', '`institutes_name`', 201, -1, FALSE, '`institutes_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->institutes_name->Sortable = TRUE; // Allow sort
		$this->fields['institutes_name'] = &$this->institutes_name;

		// tl_expiry_date
		$this->tl_expiry_date = new cField('expired_institutions', 'expired_institutions', 'x_tl_expiry_date', 'tl_expiry_date', '`tl_expiry_date`', '`tl_expiry_date`', 200, -1, FALSE, '`tl_expiry_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tl_expiry_date->Sortable = TRUE; // Allow sort
		$this->fields['tl_expiry_date'] = &$this->tl_expiry_date;

		// email
		$this->_email = new cField('expired_institutions', 'expired_institutions', 'x__email', 'email', '`email`', '`email`', 201, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`expired_institutions`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "expired_institutionslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "expired_institutionsview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "expired_institutionsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "expired_institutionsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("expired_institutionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("expired_institutionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "expired_institutionsadd.php?" . $this->UrlParm($parm);
		else
			$url = "expired_institutionsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("expired_institutionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("expired_institutionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("expired_institutionsdelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->tl_expiry_date->EditValue = $this->tl_expiry_date->CurrentValue;
