...
<!DOCTYPE html>
<html>
<link href='https://fonts.googleapis.com/earlyaccess/droidarabickufi.css' rel='stylesheet' type='text/css'> <link href='https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700' rel='stylesheet' type='text/css'>
...
<link rel="stylesheet" type="text/css" href="<?php echo $EW_RELATIVE_PATH ?>adminlte/css/<?php echo ew_CssFile("AdminLTE-rtl.css") ?>">
...
<?php } ?>
<meta name="generator" content="PHPMaker v2018.0.1">
</head>
...
<div class="wrapper ewLayout">
	...
	<aside class="main-sidebar">
		...
		<!-- Sidebar menu -->
<? if(isset($_SESSION['adid_status']) && $_SESSION['adid_status'] == 'login'){		?>
...
$userName = @$_SESSION['adid_status_UserProfile_UserName'];
$CpageN = basename($_SERVER['PHP_SELF']);
if($CpageN != 'login.php'){
if(!isset($_SESSION['adid_status']) || $_SESSION['adid_status'] ==''){
if(!isset($_SESSION['adid_status_UserLevel'])){
$_SESSION['adid_status_UserLevel'] = '-2';
}
$userLevel = @$_SESSION['adid_status_UserLevel'];
