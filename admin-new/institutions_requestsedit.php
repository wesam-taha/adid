...
$institutions_requests_edit = NULL; // Initialize page object first

class cinstitutions_requests_edit extends cinstitutions_requests {
	...
	// Page object name
	var $PageObjName = 'institutions_requests_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("institutions_requestslist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// institutions_id
			$this->institutions_id->SetDbValueDef($rsnew, $this->institutions_id->CurrentValue, 0, $this->institutions_id->ReadOnly);

			// event_name
			$this->event_name->SetDbValueDef($rsnew, $this->event_name->CurrentValue, NULL, $this->event_name->ReadOnly);

			// event_emirate
			$this->event_emirate->SetDbValueDef($rsnew, $this->event_emirate->CurrentValue, NULL, $this->event_emirate->ReadOnly);

			// event_location
			$this->event_location->SetDbValueDef($rsnew, $this->event_location->CurrentValue, NULL, $this->event_location->ReadOnly);
			...
			// activity_time
			$this->activity_time->SetDbValueDef($rsnew, $this->activity_time->CurrentValue, NULL, $this->activity_time->ReadOnly);

			// activity_description
			$this->activity_description->SetDbValueDef($rsnew, $this->activity_description->CurrentValue, NULL, $this->activity_description->ReadOnly);
			...
			// no_of_persons_needed
			$this->no_of_persons_needed->SetDbValueDef($rsnew, $this->no_of_persons_needed->CurrentValue, NULL, $this->no_of_persons_needed->ReadOnly);

			// no_of_hours
			$this->no_of_hours->SetDbValueDef($rsnew, $this->no_of_hours->CurrentValue, NULL, $this->no_of_hours->ReadOnly);
...
// Create page object
if (!isset($institutions_requests_edit)) $institutions_requests_edit = new cinstitutions_requests_edit();

// Page init
$institutions_requests_edit->Page_Init();

// Page main
$institutions_requests_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$institutions_requests_edit->Page_Render();
?>
...
var CurrentForm = finstitutions_requestsedit = new ew_Form("finstitutions_requestsedit", "edit");

// Validate form
finstitutions_requestsedit.Validate = function() {
...
finstitutions_requestsedit.Form_CustomValidate = 
...
finstitutions_requestsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finstitutions_requestsedit.Lists["x_institutions_id"] = {"LinkField":"x_institution_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_institutes_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"institutions"};
finstitutions_requestsedit.Lists["x_institutions_id"].Data = "<?php echo $institutions_requests_edit->institutions_id->LookupFilterQuery(FALSE, "edit") ?>";
finstitutions_requestsedit.Lists["x_event_emirate"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finstitutions_requestsedit.Lists["x_event_emirate"].Options = <?php echo json_encode($institutions_requests_edit->event_emirate->Options()) ?>;
finstitutions_requestsedit.Lists["x_activity_gender_target"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finstitutions_requestsedit.Lists["x_activity_gender_target"].Options = <?php echo json_encode($institutions_requests_edit->activity_gender_target->Options()) ?>;
finstitutions_requestsedit.Lists["x_admin_approval"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finstitutions_requestsedit.Lists["x_admin_approval"].Options = <?php echo json_encode($institutions_requests_edit->admin_approval->Options()) ?>;
...
<?php $institutions_requests_edit->ShowPageHeader(); ?>
<?php
$institutions_requests_edit->ShowMessage();
?>
<form name="finstitutions_requestsedit" id="finstitutions_requestsedit" class="<?php echo $institutions_requests_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($institutions_requests_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $institutions_requests_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="institutions_requests">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($institutions_requests_edit->IsModal) ?>">
<?php if (!$institutions_requests_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_institutions_requestsedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($institutions_requests->id->Visible) { // id ?>
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_institutions_requests_id" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->id->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->id->CellAttributes() ?>>
<span id="el_institutions_requests_id">
<span<?php echo $institutions_requests->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $institutions_requests->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="institutions_requests" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($institutions_requests->id->CurrentValue) ?>">
<?php echo $institutions_requests->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
...
<input type="hidden" data-table="institutions_requests" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($institutions_requests->id->CurrentValue) ?>">
<?php echo $institutions_requests->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_institutions_id" class="form-group">
		<label id="elh_institutions_requests_institutions_id" for="x_institutions_id" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->institutions_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->institutions_id->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_event_name" class="form-group">
		<label id="elh_institutions_requests_event_name" for="x_event_name" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->event_name->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->event_name->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_event_emirate" class="form-group">
		<label id="elh_institutions_requests_event_emirate" for="x_event_emirate" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->event_emirate->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->event_emirate->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_event_location" class="form-group">
		<label id="elh_institutions_requests_event_location" for="x_event_location" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->event_location->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->event_location->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_activity_start_date" class="form-group">
		<label id="elh_institutions_requests_activity_start_date" for="x_activity_start_date" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->activity_start_date->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->activity_start_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finstitutions_requestsedit", "x_activity_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_activity_end_date" class="form-group">
		<label id="elh_institutions_requests_activity_end_date" for="x_activity_end_date" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->activity_end_date->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->activity_end_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finstitutions_requestsedit", "x_activity_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_activity_time" class="form-group">
		<label id="elh_institutions_requests_activity_time" for="x_activity_time" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->activity_time->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->activity_time->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_activity_description" class="form-group">
		<label id="elh_institutions_requests_activity_description" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->activity_description->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->activity_description->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("finstitutions_requestsedit", "x_activity_description", 35, 4, <?php echo ($institutions_requests->activity_description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_activity_gender_target" class="form-group">
		<label id="elh_institutions_requests_activity_gender_target" for="x_activity_gender_target" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->activity_gender_target->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->activity_gender_target->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_no_of_persons_needed" class="form-group">
		<label id="elh_institutions_requests_no_of_persons_needed" for="x_no_of_persons_needed" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->no_of_persons_needed->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->no_of_persons_needed->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_no_of_hours" class="form-group">
		<label id="elh_institutions_requests_no_of_hours" for="x_no_of_hours" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->no_of_hours->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->no_of_hours->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_mobile_phone" class="form-group">
		<label id="elh_institutions_requests_mobile_phone" for="x_mobile_phone" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->mobile_phone->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->mobile_phone->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_pobox" class="form-group">
		<label id="elh_institutions_requests_pobox" for="x_pobox" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->pobox->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->pobox->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_admin_approval" class="form-group">
		<label id="elh_institutions_requests_admin_approval" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->admin_approval->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->admin_approval->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_admin_comment" class="form-group">
		<label id="elh_institutions_requests_admin_comment" for="x_admin_comment" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->admin_comment->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->admin_comment->CellAttributes() ?>>
...
<?php if ($institutions_requests_edit->IsMobileOrModal) { ?>
	<div id="r_email" class="form-group">
		<label id="elh_institutions_requests_email" for="x_email" class="<?php echo $institutions_requests_edit->LeftColumnClass ?>"><?php echo $institutions_requests->email->FldCaption() ?></label>
		<div class="<?php echo $institutions_requests_edit->RightColumnClass ?>"><div<?php echo $institutions_requests->email->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$institutions_requests_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $institutions_requests_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $institutions_requests_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
finstitutions_requestsedit.Init();
</script>
<?php
$institutions_requests_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$institutions_requests_edit->Page_Terminate();
?>
