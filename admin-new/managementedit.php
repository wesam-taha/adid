...
$management_edit = NULL; // Initialize page object first

class cmanagement_edit extends cmanagement {
	...
	// Page object name
	var $PageObjName = 'management_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("managementlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($management_edit)) $management_edit = new cmanagement_edit();

// Page init
$management_edit->Page_Init();

// Page main
$management_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$management_edit->Page_Render();
?>
...
var CurrentForm = fmanagementedit = new ew_Form("fmanagementedit", "edit");

// Validate form
fmanagementedit.Validate = function() {
...
fmanagementedit.Form_CustomValidate = 
...
fmanagementedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmanagementedit.Lists["x_type"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fmanagementedit.Lists["x_type"].Data = "<?php echo $management_edit->type->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $management_edit->ShowPageHeader(); ?>
<?php
$management_edit->ShowMessage();
?>
<form name="fmanagementedit" id="fmanagementedit" class="<?php echo $management_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($management_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $management_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="management">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($management_edit->IsModal) ?>">
<!-- Fields to prevent google autofill -->
<input class="hidden" type="text" name="<?php echo ew_Encrypt(ew_Random()) ?>">
<input class="hidden" type="password" name="<?php echo ew_Encrypt(ew_Random()) ?>">
<?php if (!$management_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($management_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_managementedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($management->id->Visible) { // id ?>
<?php if ($management_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_management_id" class="<?php echo $management_edit->LeftColumnClass ?>"><?php echo $management->id->FldCaption() ?></label>
		<div class="<?php echo $management_edit->RightColumnClass ?>"><div<?php echo $management->id->CellAttributes() ?>>
<span id="el_management_id">
<span<?php echo $management->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $management->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="management" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($management->id->CurrentValue) ?>">
<?php echo $management->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
...
<input type="hidden" data-table="management" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($management->id->CurrentValue) ?>">
<?php echo $management->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($management_edit->IsMobileOrModal) { ?>
	<div id="r_username" class="form-group">
		<label id="elh_management_username" for="x_username" class="<?php echo $management_edit->LeftColumnClass ?>"><?php echo $management->username->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $management_edit->RightColumnClass ?>"><div<?php echo $management->username->CellAttributes() ?>>
...
<?php if ($management_edit->IsMobileOrModal) { ?>
	<div id="r_password" class="form-group">
		<label id="elh_management_password" for="x_password" class="<?php echo $management_edit->LeftColumnClass ?>"><?php echo $management->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $management_edit->RightColumnClass ?>"><div<?php echo $management->password->CellAttributes() ?>>
...
<?php if ($management_edit->IsMobileOrModal) { ?>
	<div id="r_type" class="form-group">
		<label id="elh_management_type" for="x_type" class="<?php echo $management_edit->LeftColumnClass ?>"><?php echo $management->type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $management_edit->RightColumnClass ?>"><div<?php echo $management->type->CellAttributes() ?>>
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$management->UserIDAllow("edit")) { // Non system admin ?>
...
<?php } ?>
<?php if (!$management_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $management_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $management_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fmanagementedit.Init();
</script>
<?php
$management_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$management_edit->Page_Terminate();
?>
