...
$members_stars_criteria_edit = NULL; // Initialize page object first

class cmembers_stars_criteria_edit extends cmembers_stars_criteria {
	...
	// Page object name
	var $PageObjName = 'members_stars_criteria_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("members_stars_criterialist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($members_stars_criteria_edit)) $members_stars_criteria_edit = new cmembers_stars_criteria_edit();

// Page init
$members_stars_criteria_edit->Page_Init();

// Page main
$members_stars_criteria_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$members_stars_criteria_edit->Page_Render();
?>
...
var CurrentForm = fmembers_stars_criteriaedit = new ew_Form("fmembers_stars_criteriaedit", "edit");

// Validate form
fmembers_stars_criteriaedit.Validate = function() {
...
fmembers_stars_criteriaedit.Form_CustomValidate = 
...
fmembers_stars_criteriaedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $members_stars_criteria_edit->ShowPageHeader(); ?>
<?php
$members_stars_criteria_edit->ShowMessage();
?>
<form name="fmembers_stars_criteriaedit" id="fmembers_stars_criteriaedit" class="<?php echo $members_stars_criteria_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($members_stars_criteria_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $members_stars_criteria_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="members_stars_criteria">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($members_stars_criteria_edit->IsModal) ?>">
<?php if (!$members_stars_criteria_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($members_stars_criteria_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_members_stars_criteriaedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($members_stars_criteria->id->Visible) { // id ?>
<?php if ($members_stars_criteria_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_members_stars_criteria_id" class="<?php echo $members_stars_criteria_edit->LeftColumnClass ?>"><?php echo $members_stars_criteria->id->FldCaption() ?></label>
		<div class="<?php echo $members_stars_criteria_edit->RightColumnClass ?>"><div<?php echo $members_stars_criteria->id->CellAttributes() ?>>
<span id="el_members_stars_criteria_id">
...
<input type="hidden" data-table="members_stars_criteria" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($members_stars_criteria->id->CurrentValue) ?>">
<?php echo $members_stars_criteria->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_members_stars_criteria_id"><?php echo $members_stars_criteria->id->FldCaption() ?></span></td>
		<td<?php echo $members_stars_criteria->id->CellAttributes() ?>>
<span id="el_members_stars_criteria_id">
<span<?php echo $members_stars_criteria->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $members_stars_criteria->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="members_stars_criteria" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($members_stars_criteria->id->CurrentValue) ?>">
<?php echo $members_stars_criteria->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($members_stars_criteria_edit->IsMobileOrModal) { ?>
	<div id="r_rate_from" class="form-group">
		<label id="elh_members_stars_criteria_rate_from" for="x_rate_from" class="<?php echo $members_stars_criteria_edit->LeftColumnClass ?>"><?php echo $members_stars_criteria->rate_from->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $members_stars_criteria_edit->RightColumnClass ?>"><div<?php echo $members_stars_criteria->rate_from->CellAttributes() ?>>
...
<?php if ($members_stars_criteria_edit->IsMobileOrModal) { ?>
	<div id="r_rate_to" class="form-group">
		<label id="elh_members_stars_criteria_rate_to" for="x_rate_to" class="<?php echo $members_stars_criteria_edit->LeftColumnClass ?>"><?php echo $members_stars_criteria->rate_to->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $members_stars_criteria_edit->RightColumnClass ?>"><div<?php echo $members_stars_criteria->rate_to->CellAttributes() ?>>
...
<?php if ($members_stars_criteria_edit->IsMobileOrModal) { ?>
	<div id="r_number_of_stars" class="form-group">
		<label id="elh_members_stars_criteria_number_of_stars" for="x_number_of_stars" class="<?php echo $members_stars_criteria_edit->LeftColumnClass ?>"><?php echo $members_stars_criteria->number_of_stars->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $members_stars_criteria_edit->RightColumnClass ?>"><div<?php echo $members_stars_criteria->number_of_stars->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$members_stars_criteria_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $members_stars_criteria_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $members_stars_criteria_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fmembers_stars_criteriaedit.Init();
</script>
<?php
$members_stars_criteria_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$members_stars_criteria_edit->Page_Terminate();
?>
