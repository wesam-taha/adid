...
$rating_criteria_list_add = NULL; // Initialize page object first

class crating_criteria_list_add extends crating_criteria_list {
	...
	// Page object name
	var $PageObjName = 'rating_criteria_list_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "rating_criteria_listview.php")
...
// Create page object
if (!isset($rating_criteria_list_add)) $rating_criteria_list_add = new crating_criteria_list_add();

// Page init
$rating_criteria_list_add->Page_Init();

// Page main
$rating_criteria_list_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rating_criteria_list_add->Page_Render();
?>
...
var CurrentForm = frating_criteria_listadd = new ew_Form("frating_criteria_listadd", "add");

// Validate form
frating_criteria_listadd.Validate = function() {
...
frating_criteria_listadd.Form_CustomValidate = 
...
frating_criteria_listadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rating_criteria_list_add->ShowPageHeader(); ?>
<?php
$rating_criteria_list_add->ShowMessage();
?>
<form name="frating_criteria_listadd" id="frating_criteria_listadd" class="<?php echo $rating_criteria_list_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rating_criteria_list_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rating_criteria_list_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rating_criteria_list">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($rating_criteria_list_add->IsModal) ?>">
<?php if (!$rating_criteria_list_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($rating_criteria_list_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_rating_criteria_listadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($rating_criteria_list->name->Visible) { // name ?>
<?php if ($rating_criteria_list_add->IsMobileOrModal) { ?>
	<div id="r_name" class="form-group">
		<label id="elh_rating_criteria_list_name" for="x_name" class="<?php echo $rating_criteria_list_add->LeftColumnClass ?>"><?php echo $rating_criteria_list->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rating_criteria_list_add->RightColumnClass ?>"><div<?php echo $rating_criteria_list->name->CellAttributes() ?>>
...
<?php if ($rating_criteria_list_add->IsMobileOrModal) { ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_rating_criteria_list_name_en" for="x_name_en" class="<?php echo $rating_criteria_list_add->LeftColumnClass ?>"><?php echo $rating_criteria_list->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rating_criteria_list_add->RightColumnClass ?>"><div<?php echo $rating_criteria_list->name_en->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$rating_criteria_list_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rating_criteria_list_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rating_criteria_list_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
frating_criteria_listadd.Init();
</script>
<?php
$rating_criteria_list_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rating_criteria_list_add->Page_Terminate();
?>
