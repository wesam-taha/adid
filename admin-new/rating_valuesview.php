...
$rating_values_view = NULL; // Initialize page object first

class crating_values_view extends crating_values {
	...
	// Page object name
	var $PageObjName = 'rating_values_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "rating_valueslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "rating_valueslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "rating_valueslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($rating_values_view)) $rating_values_view = new crating_values_view();

// Page init
$rating_values_view->Page_Init();

// Page main
$rating_values_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rating_values_view->Page_Render();
?>
...
var CurrentForm = frating_valuesview = new ew_Form("frating_valuesview", "view");

// Form_CustomValidate event
frating_valuesview.Form_CustomValidate = 
...
frating_valuesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frating_valuesview.Lists["x_user_id"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_full_name_ar","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
frating_valuesview.Lists["x_user_id"].Data = "<?php echo $rating_values_view->user_id->LookupFilterQuery(FALSE, "view") ?>";
frating_valuesview.Lists["x_event_id"] = {"LinkField":"x_activity_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_activity_name_ar","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"activities"};
frating_valuesview.Lists["x_event_id"].Data = "<?php echo $rating_values_view->event_id->LookupFilterQuery(FALSE, "view") ?>";
frating_valuesview.Lists["x_rated_by"] = {"LinkField":"x_user_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_full_name_ar","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
frating_valuesview.Lists["x_rated_by"].Data = "<?php echo $rating_values_view->rated_by->LookupFilterQuery(FALSE, "view") ?>";
frating_valuesview.Lists["x_rating_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"rating_criteria_list"};
frating_valuesview.Lists["x_rating_type"].Data = "<?php echo $rating_values_view->rating_type->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($rating_values->Export == "") { ?>
<div class="ewToolbar">
<?php $rating_values_view->ExportOptions->Render("body") ?>
<?php
	foreach ($rating_values_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $rating_values_view->ShowPageHeader(); ?>
<?php
$rating_values_view->ShowMessage();
?>
<form name="frating_valuesview" id="frating_valuesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rating_values_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rating_values_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rating_values">
<input type="hidden" name="modal" value="<?php echo intval($rating_values_view->IsModal) ?>">
...
<?php echo $rating_values->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($rating_values->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td class="col-sm-2"><span id="elh_rating_values_user_id"><?php echo $rating_values->user_id->FldCaption() ?></span></td>
...
<?php echo $rating_values->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $rating_values->event_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $rating_values->rated_by->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $rating_values->rating_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $rating_values->rating_value->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($rating_values->Export == "") { ?>
<script type="text/javascript">
frating_valuesview.Init();
</script>
<?php } ?>
<?php
$rating_values_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($rating_values->Export == "") { ?>
...
<?php
$rating_values_view->Page_Terminate();
?>
