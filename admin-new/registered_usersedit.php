...
$registered_users_edit = NULL; // Initialize page object first

class cregistered_users_edit extends cregistered_users {
	...
	// Page object name
	var $PageObjName = 'registered_users_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("registered_userslist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// evaluation_rate
			$this->evaluation_rate->SetDbValueDef($rsnew, $this->evaluation_rate->CurrentValue, NULL, $this->evaluation_rate->ReadOnly);

			// Check referential integrity for master table 'activities'
			$bValidMasterRecord = TRUE;
			$sMasterFilter = $this->SqlMasterFilter_activities();
			$KeyValue = isset($rsnew['activity_id']) ? $rsnew['activity_id'] : $rsold['activity_id'];
			if (strval($KeyValue) <> "") {
				$sMasterFilter = str_replace("@activity_id@", ew_AdjustSql($KeyValue), $sMasterFilter);
			} else {
...
// Create page object
if (!isset($registered_users_edit)) $registered_users_edit = new cregistered_users_edit();

// Page init
$registered_users_edit->Page_Init();

// Page main
$registered_users_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$registered_users_edit->Page_Render();
?>
...
var CurrentForm = fregistered_usersedit = new ew_Form("fregistered_usersedit", "edit");

// Validate form
fregistered_usersedit.Validate = function() {
...
fregistered_usersedit.Form_CustomValidate = 
...
fregistered_usersedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fregistered_usersedit.Lists["x_activity_id"] = {"LinkField":"x_activity_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_activity_name_ar","x_activity_start_date","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"activities"};
fregistered_usersedit.Lists["x_activity_id"].Data = "<?php echo $registered_users_edit->activity_id->LookupFilterQuery(FALSE, "edit") ?>";
fregistered_usersedit.Lists["x_admin_approval"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fregistered_usersedit.Lists["x_admin_approval"].Options = <?php echo json_encode($registered_users_edit->admin_approval->Options()) ?>;
...
<?php $registered_users_edit->ShowPageHeader(); ?>
<?php
$registered_users_edit->ShowMessage();
?>
<form name="fregistered_usersedit" id="fregistered_usersedit" class="<?php echo $registered_users_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($registered_users_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $registered_users_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="registered_users">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($registered_users_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$registered_users_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_registered_usersedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($registered_users->id->Visible) { // id ?>
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_registered_users_id" class="<?php echo $registered_users_edit->LeftColumnClass ?>"><?php echo $registered_users->id->FldCaption() ?></label>
		<div class="<?php echo $registered_users_edit->RightColumnClass ?>"><div<?php echo $registered_users->id->CellAttributes() ?>>
...
<input type="hidden" data-table="registered_users" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($registered_users->id->CurrentValue) ?>">
<?php echo $registered_users->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
...
<input type="hidden" data-table="registered_users" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($registered_users->id->CurrentValue) ?>">
<?php echo $registered_users->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
	<div id="r_activity_id" class="form-group">
		<label id="elh_registered_users_activity_id" for="x_activity_id" class="<?php echo $registered_users_edit->LeftColumnClass ?>"><?php echo $registered_users->activity_id->FldCaption() ?></label>
		<div class="<?php echo $registered_users_edit->RightColumnClass ?>"><div<?php echo $registered_users->activity_id->CellAttributes() ?>>
...
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_registered_users_user_id" for="x_user_id" class="<?php echo $registered_users_edit->LeftColumnClass ?>"><?php echo $registered_users->user_id->FldCaption() ?></label>
		<div class="<?php echo $registered_users_edit->RightColumnClass ?>"><div<?php echo $registered_users->user_id->CellAttributes() ?>>
...
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
	<div id="r_admin_approval" class="form-group">
		<label id="elh_registered_users_admin_approval" class="<?php echo $registered_users_edit->LeftColumnClass ?>"><?php echo $registered_users->admin_approval->FldCaption() ?></label>
		<div class="<?php echo $registered_users_edit->RightColumnClass ?>"><div<?php echo $registered_users->admin_approval->CellAttributes() ?>>
...
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
	<div id="r_admin_comment" class="form-group">
		<label id="elh_registered_users_admin_comment" for="x_admin_comment" class="<?php echo $registered_users_edit->LeftColumnClass ?>"><?php echo $registered_users->admin_comment->FldCaption() ?></label>
		<div class="<?php echo $registered_users_edit->RightColumnClass ?>"><div<?php echo $registered_users->admin_comment->CellAttributes() ?>>
...
<?php if ($registered_users_edit->IsMobileOrModal) { ?>
	<div id="r_evaluation_rate" class="form-group">
		<label id="elh_registered_users_evaluation_rate" for="x_evaluation_rate" class="<?php echo $registered_users_edit->LeftColumnClass ?>"><?php echo $registered_users->evaluation_rate->FldCaption() ?></label>
		<div class="<?php echo $registered_users_edit->RightColumnClass ?>"><div<?php echo $registered_users->evaluation_rate->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$registered_users_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $registered_users_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $registered_users_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fregistered_usersedit.Init();
</script>
<?php
$registered_users_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$registered_users_edit->Page_Terminate();
?>
