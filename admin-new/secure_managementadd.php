...
$secure_management_add = NULL; // Initialize page object first

class csecure_management_add extends csecure_management {
	...
	// Page object name
	var $PageObjName = 'secure_management_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "secure_managementview.php")
...
// Create page object
if (!isset($secure_management_add)) $secure_management_add = new csecure_management_add();

// Page init
$secure_management_add->Page_Init();

// Page main
$secure_management_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$secure_management_add->Page_Render();
?>
...
var CurrentForm = fsecure_managementadd = new ew_Form("fsecure_managementadd", "add");

// Validate form
fsecure_managementadd.Validate = function() {
...
fsecure_managementadd.Form_CustomValidate = 
...
fsecure_managementadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsecure_managementadd.Lists["x_type"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"secureuserlevels"};
fsecure_managementadd.Lists["x_type"].Data = "<?php echo $secure_management_add->type->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $secure_management_add->ShowPageHeader(); ?>
<?php
$secure_management_add->ShowMessage();
?>
<form name="fsecure_managementadd" id="fsecure_managementadd" class="<?php echo $secure_management_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($secure_management_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $secure_management_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="secure_management">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($secure_management_add->IsModal) ?>">
<!-- Fields to prevent google autofill -->
<input class="hidden" type="text" name="<?php echo ew_Encrypt(ew_Random()) ?>">
<input class="hidden" type="password" name="<?php echo ew_Encrypt(ew_Random()) ?>">
<?php if (!$secure_management_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($secure_management_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_secure_managementadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($secure_management->username->Visible) { // username ?>
<?php if ($secure_management_add->IsMobileOrModal) { ?>
	<div id="r_username" class="form-group">
		<label id="elh_secure_management_username" for="x_username" class="<?php echo $secure_management_add->LeftColumnClass ?>"><?php echo $secure_management->username->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $secure_management_add->RightColumnClass ?>"><div<?php echo $secure_management->username->CellAttributes() ?>>
...
<?php if ($secure_management_add->IsMobileOrModal) { ?>
	<div id="r_password" class="form-group">
		<label id="elh_secure_management_password" for="x_password" class="<?php echo $secure_management_add->LeftColumnClass ?>"><?php echo $secure_management->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $secure_management_add->RightColumnClass ?>"><div<?php echo $secure_management->password->CellAttributes() ?>>
...
<?php if ($secure_management_add->IsMobileOrModal) { ?>
	<div id="r_type" class="form-group">
		<label id="elh_secure_management_type" for="x_type" class="<?php echo $secure_management_add->LeftColumnClass ?>"><?php echo $secure_management->type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $secure_management_add->RightColumnClass ?>"><div<?php echo $secure_management->type->CellAttributes() ?>>
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$secure_management->UserIDAllow("add")) { // Non system admin ?>
...
<?php } ?>
<?php if (!$secure_management_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $secure_management_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $secure_management_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fsecure_managementadd.Init();
</script>
<?php
$secure_management_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$secure_management_add->Page_Terminate();
?>
