...
$secure_management_search = NULL; // Initialize page object first

class csecure_management_search extends csecure_management {
	...
	// Page object name
	var $PageObjName = 'secure_management_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "secure_managementlist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($secure_management_search)) $secure_management_search = new csecure_management_search();

// Page init
$secure_management_search->Page_Init();

// Page main
$secure_management_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$secure_management_search->Page_Render();
?>
...
<?php if ($secure_management_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fsecure_managementsearch = new ew_Form("fsecure_managementsearch", "search");
<?php } else { ?>
var CurrentForm = fsecure_managementsearch = new ew_Form("fsecure_managementsearch", "search");
<?php } ?>

// Form_CustomValidate event
fsecure_managementsearch.Form_CustomValidate = 
...
fsecure_managementsearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsecure_managementsearch.Lists["x_type"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fsecure_managementsearch.Lists["x_type"].Data = "<?php echo $secure_management_search->type->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fsecure_managementsearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($secure_management->id->FldErrMsg()) ?>");
...
<?php $secure_management_search->ShowPageHeader(); ?>
<?php
$secure_management_search->ShowMessage();
?>
<form name="fsecure_managementsearch" id="fsecure_managementsearch" class="<?php echo $secure_management_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($secure_management_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $secure_management_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="secure_management">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($secure_management_search->IsModal) ?>">
<?php if (!$secure_management_search->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($secure_management_search->IsMobileOrModal) { ?>
<div class="ewSearchDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_secure_managementsearch" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($secure_management->id->Visible) { // id ?>
<?php if ($secure_management_search->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label for="x_id" class="<?php echo $secure_management_search->LeftColumnClass ?>"><span id="elh_secure_management_id"><?php echo $secure_management->id->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_id" id="z_id" value="="></p>
		</label>
		<div class="<?php echo $secure_management_search->RightColumnClass ?>"><div<?php echo $secure_management->id->CellAttributes() ?>>
			<span id="el_secure_management_id">
<input type="text" data-table="secure_management" data-field="x_id" name="x_id" id="x_id" placeholder="<?php echo ew_HtmlEncode($secure_management->id->getPlaceHolder()) ?>" value="<?php echo $secure_management->id->EditValue ?>"<?php echo $secure_management->id->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } else { ?>
...
<?php if ($secure_management_search->IsMobileOrModal) { ?>
	<div id="r_username" class="form-group">
		<label for="x_username" class="<?php echo $secure_management_search->LeftColumnClass ?>"><span id="elh_secure_management_username"><?php echo $secure_management->username->FldCaption() ?></span>
		...
		<div class="<?php echo $secure_management_search->RightColumnClass ?>"><div<?php echo $secure_management->username->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_username">
		<td class="col-sm-2"><span id="elh_secure_management_username"><?php echo $secure_management->username->FldCaption() ?></span></td>
...
<?php if ($secure_management_search->IsMobileOrModal) { ?>
	<div id="r_password" class="form-group">
		<label for="x_password" class="<?php echo $secure_management_search->LeftColumnClass ?>"><span id="elh_secure_management_password"><?php echo $secure_management->password->FldCaption() ?></span>
		...
		<div class="<?php echo $secure_management_search->RightColumnClass ?>"><div<?php echo $secure_management->password->CellAttributes() ?>>
			<span id="el_secure_management_password">
<input type="text" data-table="secure_management" data-field="x_password" name="x_password" id="x_password" placeholder="<?php echo ew_HtmlEncode($secure_management->password->getPlaceHolder()) ?>" value="<?php echo $secure_management->password->EditValue ?>"<?php echo $secure_management->password->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } else { ?>
	<tr id="r_password">
		<td class="col-sm-2"><span id="elh_secure_management_password"><?php echo $secure_management->password->FldCaption() ?></span></td>
...
<?php if ($secure_management_search->IsMobileOrModal) { ?>
	<div id="r_type" class="form-group">
		<label for="x_type" class="<?php echo $secure_management_search->LeftColumnClass ?>"><span id="elh_secure_management_type"><?php echo $secure_management->type->FldCaption() ?></span>
		...
		<div class="<?php echo $secure_management_search->RightColumnClass ?>"><div<?php echo $secure_management->type->CellAttributes() ?>>
			<span id="el_secure_management_type">
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn() && !$secure_management->UserIDAllow("search")) { // Non system admin ?>
...
<input type="hidden" data-table="secure_management" data-field="x_type" name="x_type" id="x_type" value="<?php echo ew_HtmlEncode($secure_management->type->AdvancedSearch->SearchValue) ?>">
...
<?php } else { ?>
	<tr id="r_type">
		<td class="col-sm-2"><span id="elh_secure_management_type"><?php echo $secure_management->type->FldCaption() ?></span></td>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $secure_management_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fsecure_managementsearch.Init();
</script>
<?php
$secure_management_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$secure_management_search->Page_Terminate();
?>
