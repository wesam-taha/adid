...
$special_requests_add = NULL; // Initialize page object first

class cspecial_requests_add extends cspecial_requests {
	...
	// Page object name
	var $PageObjName = 'special_requests_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "special_requestsview.php")
...
// Create page object
if (!isset($special_requests_add)) $special_requests_add = new cspecial_requests_add();

// Page init
$special_requests_add->Page_Init();

// Page main
$special_requests_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$special_requests_add->Page_Render();
?>
...
var CurrentForm = fspecial_requestsadd = new ew_Form("fspecial_requestsadd", "add");

// Validate form
fspecial_requestsadd.Validate = function() {
...
fspecial_requestsadd.Form_CustomValidate = 
...
fspecial_requestsadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fspecial_requestsadd.Lists["x_security_approval"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fspecial_requestsadd.Lists["x_security_approval"].Options = <?php echo json_encode($special_requests_add->security_approval->Options()) ?>;
...
<?php $special_requests_add->ShowPageHeader(); ?>
<?php
$special_requests_add->ShowMessage();
?>
<form name="fspecial_requestsadd" id="fspecial_requestsadd" class="<?php echo $special_requests_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($special_requests_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $special_requests_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="special_requests">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($special_requests_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($special_requests->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_special_requests_title" for="x_title" class="<?php echo $special_requests_add->LeftColumnClass ?>"><?php echo $special_requests->title->FldCaption() ?></label>
		<div class="<?php echo $special_requests_add->RightColumnClass ?>"><div<?php echo $special_requests->title->CellAttributes() ?>>
...
<?php if ($special_requests->message->Visible) { // message ?>
	<div id="r_message" class="form-group">
		<label id="elh_special_requests_message" for="x_message" class="<?php echo $special_requests_add->LeftColumnClass ?>"><?php echo $special_requests->message->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $special_requests_add->RightColumnClass ?>"><div<?php echo $special_requests->message->CellAttributes() ?>>
...
<?php if ($special_requests->security_approval->Visible) { // security_approval ?>
	<div id="r_security_approval" class="form-group">
		<label id="elh_special_requests_security_approval" class="<?php echo $special_requests_add->LeftColumnClass ?>"><?php echo $special_requests->security_approval->FldCaption() ?></label>
		<div class="<?php echo $special_requests_add->RightColumnClass ?>"><div<?php echo $special_requests->security_approval->CellAttributes() ?>>
...
<?php if ($special_requests->security_comment->Visible) { // security_comment ?>
	<div id="r_security_comment" class="form-group">
		<label id="elh_special_requests_security_comment" for="x_security_comment" class="<?php echo $special_requests_add->LeftColumnClass ?>"><?php echo $special_requests->security_comment->FldCaption() ?></label>
		<div class="<?php echo $special_requests_add->RightColumnClass ?>"><div<?php echo $special_requests->security_comment->CellAttributes() ?>>
...
<?php if (!$special_requests_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $special_requests_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $special_requests_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fspecial_requestsadd.Init();
</script>
<?php
$special_requests_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$special_requests_add->Page_Terminate();
?>
