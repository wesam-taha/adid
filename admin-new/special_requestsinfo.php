...
//
// Table class for special_requests
//
class cspecial_requests extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'special_requests';
		$this->TableName = 'special_requests';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`special_requests`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('special_requests', 'special_requests', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('special_requests', 'special_requests', 'x_title', 'title', '`title`', '`title`', 201, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->title->Sortable = TRUE; // Allow sort
		$this->fields['title'] = &$this->title;

		// message
		$this->message = new cField('special_requests', 'special_requests', 'x_message', 'message', '`message`', '`message`', 201, -1, FALSE, '`message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->message->Sortable = TRUE; // Allow sort
		$this->fields['message'] = &$this->message;

		// security_approval
		$this->security_approval = new cField('special_requests', 'special_requests', 'x_security_approval', 'security_approval', '`security_approval`', '`security_approval`', 3, -1, FALSE, '`security_approval`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// security_comment
		$this->security_comment = new cField('special_requests', 'special_requests', 'x_security_comment', 'security_comment', '`security_comment`', '`security_comment`', 201, -1, FALSE, '`security_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`special_requests`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "special_requestslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "special_requestsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "special_requestsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("special_requestsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("special_requestsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "special_requestsadd.php?" . $this->UrlParm($parm);
		else
			$url = "special_requestsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("special_requestsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("special_requestsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("special_requestsdelete.php", $this->UrlParm());
	}
