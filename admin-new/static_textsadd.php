...
$static_texts_add = NULL; // Initialize page object first

class cstatic_texts_add extends cstatic_texts {
	...
	// Page object name
	var $PageObjName = 'static_texts_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "static_textsview.php")
...
// Create page object
if (!isset($static_texts_add)) $static_texts_add = new cstatic_texts_add();

// Page init
$static_texts_add->Page_Init();

// Page main
$static_texts_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$static_texts_add->Page_Render();
?>
...
var CurrentForm = fstatic_textsadd = new ew_Form("fstatic_textsadd", "add");

// Validate form
fstatic_textsadd.Validate = function() {
...
fstatic_textsadd.Form_CustomValidate = 
...
fstatic_textsadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $static_texts_add->ShowPageHeader(); ?>
<?php
$static_texts_add->ShowMessage();
?>
<form name="fstatic_textsadd" id="fstatic_textsadd" class="<?php echo $static_texts_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($static_texts_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $static_texts_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="static_texts">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($static_texts_add->IsModal) ?>">
<?php if (!$static_texts_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($static_texts_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_static_textsadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($static_texts->label_text->Visible) { // label_text ?>
<?php if ($static_texts_add->IsMobileOrModal) { ?>
	<div id="r_label_text" class="form-group">
		<label id="elh_static_texts_label_text" for="x_label_text" class="<?php echo $static_texts_add->LeftColumnClass ?>"><?php echo $static_texts->label_text->FldCaption() ?></label>
		<div class="<?php echo $static_texts_add->RightColumnClass ?>"><div<?php echo $static_texts->label_text->CellAttributes() ?>>
...
<?php if ($static_texts_add->IsMobileOrModal) { ?>
	<div id="r_genuine_text_ar" class="form-group">
		<label id="elh_static_texts_genuine_text_ar" for="x_genuine_text_ar" class="<?php echo $static_texts_add->LeftColumnClass ?>"><?php echo $static_texts->genuine_text_ar->FldCaption() ?></label>
		<div class="<?php echo $static_texts_add->RightColumnClass ?>"><div<?php echo $static_texts->genuine_text_ar->CellAttributes() ?>>
...
<?php if ($static_texts_add->IsMobileOrModal) { ?>
	<div id="r_genuine_text_en" class="form-group">
		<label id="elh_static_texts_genuine_text_en" for="x_genuine_text_en" class="<?php echo $static_texts_add->LeftColumnClass ?>"><?php echo $static_texts->genuine_text_en->FldCaption() ?></label>
		<div class="<?php echo $static_texts_add->RightColumnClass ?>"><div<?php echo $static_texts->genuine_text_en->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$static_texts_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $static_texts_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $static_texts_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fstatic_textsadd.Init();
</script>
<?php
$static_texts_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$static_texts_add->Page_Terminate();
?>
