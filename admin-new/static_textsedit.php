...
$static_texts_edit = NULL; // Initialize page object first

class cstatic_texts_edit extends cstatic_texts {
	...
	// Page object name
	var $PageObjName = 'static_texts_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("static_textslist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("static_textslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "static_textslist.php")
...
// Create page object
if (!isset($static_texts_edit)) $static_texts_edit = new cstatic_texts_edit();

// Page init
$static_texts_edit->Page_Init();

// Page main
$static_texts_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$static_texts_edit->Page_Render();
?>
...
var CurrentForm = fstatic_textsedit = new ew_Form("fstatic_textsedit", "edit");

// Validate form
fstatic_textsedit.Validate = function() {
...
fstatic_textsedit.Form_CustomValidate = 
...
fstatic_textsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $static_texts_edit->ShowPageHeader(); ?>
<?php
$static_texts_edit->ShowMessage();
?>
<form name="fstatic_textsedit" id="fstatic_textsedit" class="<?php echo $static_texts_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($static_texts_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $static_texts_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="static_texts">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($static_texts_edit->IsModal) ?>">
<?php if (!$static_texts_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($static_texts_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_static_textsedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($static_texts->id->Visible) { // id ?>
<?php if ($static_texts_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_static_texts_id" class="<?php echo $static_texts_edit->LeftColumnClass ?>"><?php echo $static_texts->id->FldCaption() ?></label>
		<div class="<?php echo $static_texts_edit->RightColumnClass ?>"><div<?php echo $static_texts->id->CellAttributes() ?>>
...
<input type="hidden" data-table="static_texts" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($static_texts->id->CurrentValue) ?>">
<?php echo $static_texts->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
...
<input type="hidden" data-table="static_texts" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($static_texts->id->CurrentValue) ?>">
<?php echo $static_texts->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($static_texts_edit->IsMobileOrModal) { ?>
	<div id="r_label_text" class="form-group">
		<label id="elh_static_texts_label_text" for="x_label_text" class="<?php echo $static_texts_edit->LeftColumnClass ?>"><?php echo $static_texts->label_text->FldCaption() ?></label>
		<div class="<?php echo $static_texts_edit->RightColumnClass ?>"><div<?php echo $static_texts->label_text->CellAttributes() ?>>
...
<?php echo $static_texts->label_text->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_label_text">
...
<?php echo $static_texts->label_text->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($static_texts_edit->IsMobileOrModal) { ?>
	<div id="r_genuine_text_ar" class="form-group">
		<label id="elh_static_texts_genuine_text_ar" for="x_genuine_text_ar" class="<?php echo $static_texts_edit->LeftColumnClass ?>"><?php echo $static_texts->genuine_text_ar->FldCaption() ?></label>
		<div class="<?php echo $static_texts_edit->RightColumnClass ?>"><div<?php echo $static_texts->genuine_text_ar->CellAttributes() ?>>
<span id="el_static_texts_genuine_text_ar">
<textarea data-table="static_texts" data-field="x_genuine_text_ar" name="x_genuine_text_ar" id="x_genuine_text_ar" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($static_texts->genuine_text_ar->getPlaceHolder()) ?>"<?php echo $static_texts->genuine_text_ar->EditAttributes() ?>><?php echo $static_texts->genuine_text_ar->EditValue ?></textarea>
</span>
<?php echo $static_texts->genuine_text_ar->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
...
<?php echo $static_texts->genuine_text_ar->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($static_texts_edit->IsMobileOrModal) { ?>
	<div id="r_genuine_text_en" class="form-group">
		<label id="elh_static_texts_genuine_text_en" for="x_genuine_text_en" class="<?php echo $static_texts_edit->LeftColumnClass ?>"><?php echo $static_texts->genuine_text_en->FldCaption() ?></label>
		<div class="<?php echo $static_texts_edit->RightColumnClass ?>"><div<?php echo $static_texts->genuine_text_en->CellAttributes() ?>>
<span id="el_static_texts_genuine_text_en">
<textarea data-table="static_texts" data-field="x_genuine_text_en" name="x_genuine_text_en" id="x_genuine_text_en" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($static_texts->genuine_text_en->getPlaceHolder()) ?>"<?php echo $static_texts->genuine_text_en->EditAttributes() ?>><?php echo $static_texts->genuine_text_en->EditValue ?></textarea>
</span>
<?php echo $static_texts->genuine_text_en->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
...
<?php echo $static_texts->genuine_text_en->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($static_texts_edit->IsMobileOrModal) { ?>
...
<?php } ?>
<?php if (!$static_texts_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $static_texts_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $static_texts_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fstatic_textsedit.Init();
</script>
<?php
$static_texts_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$static_texts_edit->Page_Terminate();
?>
