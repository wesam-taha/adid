...
//
// Table class for user_attachments
//
class cuser_attachments extends cTable {
	var $id;
	var $_userid;
	var $description;
	var $hours;
	...
	function __construct() {
		...
		$this->TableVar = 'user_attachments';
		$this->TableName = 'user_attachments';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`user_attachments`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('user_attachments', 'user_attachments', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// userid
		$this->_userid = new cField('user_attachments', 'user_attachments', 'x__userid', 'userid', '`userid`', '`userid`', 3, -1, FALSE, '`userid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_userid->Sortable = TRUE; // Allow sort
		$this->_userid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userid'] = &$this->_userid;

		// description
		$this->description = new cField('user_attachments', 'user_attachments', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// hours
		$this->hours = new cField('user_attachments', 'user_attachments', 'x_hours', 'hours', '`hours`', '`hours`', 201, -1, FALSE, '`hours`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hours->Sortable = TRUE; // Allow sort
		$this->fields['hours'] = &$this->hours;

		// file
		$this->file = new cField('user_attachments', 'user_attachments', 'x_file', 'file', '`file`', '`file`', 201, -1, TRUE, '`file`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->file->Sortable = TRUE; // Allow sort
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "users") {
			if ($this->_userid->getSessionValue() <> "")
				$sMasterFilter .= "`user_id`=" . ew_QuotedValue($this->_userid->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`user_attachments`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "user_attachmentslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "user_attachmentsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "user_attachmentsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("user_attachmentsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("user_attachmentsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "user_attachmentsadd.php?" . $this->UrlParm($parm);
		else
			$url = "user_attachmentsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("user_attachmentsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("user_attachmentsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("user_attachmentsdelete.php", $this->UrlParm());
	}
	...
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "users" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
			...
			$url .= "&fk_user_id=" . urlencode($this->_userid->CurrentValue);
		}
		return $url;
	}
