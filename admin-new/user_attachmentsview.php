...
$user_attachments_view = NULL; // Initialize page object first

class cuser_attachments_view extends cuser_attachments {
	...
	// Page object name
	var $PageObjName = 'user_attachments_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "user_attachmentslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "user_attachmentslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "user_attachmentslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($user_attachments_view)) $user_attachments_view = new cuser_attachments_view();

// Page init
$user_attachments_view->Page_Init();

// Page main
$user_attachments_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$user_attachments_view->Page_Render();
?>
...
var CurrentForm = fuser_attachmentsview = new ew_Form("fuser_attachmentsview", "view");

// Form_CustomValidate event
fuser_attachmentsview.Form_CustomValidate = 
...
fuser_attachmentsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($user_attachments->Export == "") { ?>
<div class="ewToolbar">
<?php $user_attachments_view->ExportOptions->Render("body") ?>
<?php
	foreach ($user_attachments_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $user_attachments_view->ShowPageHeader(); ?>
<?php
$user_attachments_view->ShowMessage();
?>
<form name="fuser_attachmentsview" id="fuser_attachmentsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($user_attachments_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $user_attachments_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="user_attachments">
<input type="hidden" name="modal" value="<?php echo intval($user_attachments_view->IsModal) ?>">
...
<?php echo $user_attachments->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $user_attachments->_userid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $user_attachments->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $user_attachments->hours->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo ew_GetFileViewTag($user_attachments->file, $user_attachments->file->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($user_attachments->Export == "") { ?>
<script type="text/javascript">
fuser_attachmentsview.Init();
</script>
<?php } ?>
<?php
$user_attachments_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($user_attachments->Export == "") { ?>
...
<?php
$user_attachments_view->Page_Terminate();
?>
