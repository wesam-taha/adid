...
<?php } else { ?>
<table id="tbl_userlevelpermissionsedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
...
<?php } else { ?>
	<tr id="r_userlevelid">
		<td class="col-sm-2"><span id="elh_userlevelpermissions_userlevelid"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php } else { ?>
	<tr id="r__tablename">
		<td class="col-sm-2"><span id="elh_userlevelpermissions__tablename"><?php echo $userlevelpermissions->_tablename->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php } else { ?>
	<tr id="r_permission">
		<td class="col-sm-2"><span id="elh_userlevelpermissions_permission"><?php echo $userlevelpermissions->permission->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
