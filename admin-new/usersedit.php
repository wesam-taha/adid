...
class cusers_edit extends cusers {
	...
	function RenderRow() {
		...
		$this->title_number->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->personal_photo);
	...
	function ValidateForm() {
		...
		if (in_array("user_attachments", $DetailTblVar) && $GLOBALS["user_attachments"]->DetailEdit) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// date_of_birth
			$this->date_of_birth->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_of_birth->CurrentValue, 0), NULL, $this->date_of_birth->ReadOnly);

			// personal_photo
			if ($this->personal_photo->Visible && !$this->personal_photo->ReadOnly && !$this->personal_photo->Upload->KeepFile) {
				$this->personal_photo->Upload->DbValue = $rsold['personal_photo']; // Get original value
			...
			// blood_type
			$this->blood_type->SetDbValueDef($rsnew, $this->blood_type->CurrentValue, NULL, $this->blood_type->ReadOnly);

			// driving_licence
			$this->driving_licence->SetDbValueDef($rsnew, $this->driving_licence->CurrentValue, NULL, $this->driving_licence->ReadOnly);

			// job
			$this->job->SetDbValueDef($rsnew, $this->job->CurrentValue, NULL, $this->job->ReadOnly);
			...
			// nationality_type
			$this->nationality_type->SetDbValueDef($rsnew, $this->nationality_type->CurrentValue, NULL, $this->nationality_type->ReadOnly);

			// nationality
			$this->nationality->SetDbValueDef($rsnew, $this->nationality->CurrentValue, NULL, $this->nationality->ReadOnly);

			// unid
			$this->unid->SetDbValueDef($rsnew, $this->unid->CurrentValue, NULL, $this->unid->ReadOnly);

			// visa_expiry_date
			$this->visa_expiry_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->visa_expiry_date->CurrentValue, 0), NULL, $this->visa_expiry_date->ReadOnly);
			...
			// qualifications
			$this->qualifications->SetDbValueDef($rsnew, $this->qualifications->CurrentValue, NULL, $this->qualifications->ReadOnly);
			...
			// home_phone
			$this->home_phone->SetDbValueDef($rsnew, $this->home_phone->CurrentValue, NULL, $this->home_phone->ReadOnly);
			...
			// total_voluntary_hours
			$this->total_voluntary_hours->SetDbValueDef($rsnew, $this->total_voluntary_hours->CurrentValue, NULL, $this->total_voluntary_hours->ReadOnly);

			// overall_evaluation
			$this->overall_evaluation->SetDbValueDef($rsnew, $this->overall_evaluation->CurrentValue, NULL, $this->overall_evaluation->ReadOnly);
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("user_attachments", $DetailTblVar) && $GLOBALS["user_attachments"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["user_attachments_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("user_attachments", $DetailTblVar)) {
				...
				if ($GLOBALS["user_attachments_grid"]->DetailEdit) {
					$GLOBALS["user_attachments_grid"]->CurrentMode = "edit";
					$GLOBALS["user_attachments_grid"]->CurrentAction = "gridedit";
...
fusersedit.Lists["x_group_id[]"] = {"LinkField":"x_institution_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_institutes_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"institutions"};
fusersedit.Lists["x_group_id[]"].Data = "<?php echo $users_edit->group_id->LookupFilterQuery(FALSE, "edit") ?>";
...
fusersedit.Lists["x_blood_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_blood_type"].Options = <?php echo json_encode($users_edit->blood_type->Options()) ?>;
fusersedit.Lists["x_driving_licence"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_driving_licence"].Options = <?php echo json_encode($users_edit->driving_licence->Options()) ?>;
fusersedit.Lists["x_job"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_job"].Options = <?php echo json_encode($users_edit->job->Options()) ?>;
fusersedit.Lists["x_volunteering_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_volunteering_type"].Options = <?php echo json_encode($users_edit->volunteering_type->Options()) ?>;
fusersedit.Lists["x_marital_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_marital_status"].Options = <?php echo json_encode($users_edit->marital_status->Options()) ?>;
fusersedit.Lists["x_nationality_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_nationality_type"].Options = <?php echo json_encode($users_edit->nationality_type->Options()) ?>;
fusersedit.Lists["x_current_emirate"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_current_emirate"].Options = <?php echo json_encode($users_edit->current_emirate->Options()) ?>;
fusersedit.Lists["x_admin_approval"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_admin_approval"].Options = <?php echo json_encode($users_edit->admin_approval->Options()) ?>;
fusersedit.Lists["x_security_approval"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusersedit.Lists["x_security_approval"].Options = <?php echo json_encode($users_edit->security_approval->Options()) ?>;
...
<div class="nav-tabs-custom" id="users_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $users_edit->MultiPages->NavStyle() ?>">
		...
		<li<?php echo $users_edit->MultiPages->TabStyle("4") ?>><a href="#tab_users4" data-toggle="tab"><?php echo $users->PageCaption(4) ?></a></li>
		<li<?php echo $users_edit->MultiPages->TabStyle("5") ?>><a href="#tab_users5" data-toggle="tab"><?php echo $users->PageCaption(5) ?></a></li>
		<li<?php echo $users_edit->MultiPages->TabStyle("6") ?>><a href="#tab_users6" data-toggle="tab"><?php echo $users->PageCaption(6) ?></a></li>
		<li<?php echo $users_edit->MultiPages->TabStyle("7") ?>><a href="#tab_users7" data-toggle="tab"><?php echo $users->PageCaption(7) ?></a></li>
	</ul>
...
<?php } else { ?>
<table id="tbl_usersedit1" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($users->user_id->Visible) { // user_id ?>
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_users_user_id" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->user_id->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->user_id->CellAttributes() ?>>
...
<input type="hidden" data-table="users" data-field="x_user_id" data-page="1" name="x_user_id" id="x_user_id" value="<?php echo ew_HtmlEncode($users->user_id->CurrentValue) ?>">
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_group_id" class="form-group">
		<label id="elh_users_group_id" for="x_group_id" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->group_id->FldCaption() ?></label>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_full_name_ar" class="form-group">
		<label id="elh_users_full_name_ar" for="x_full_name_ar" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->full_name_ar->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->full_name_ar->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_full_name_en" class="form-group">
		<label id="elh_users_full_name_en" for="x_full_name_en" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->full_name_en->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->full_name_en->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_date_of_birth" class="form-group">
		<label id="elh_users_date_of_birth" for="x_date_of_birth" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->date_of_birth->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->date_of_birth->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fusersedit", "x_date_of_birth", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_personal_photo" class="form-group">
		<label id="elh_users_personal_photo" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->personal_photo->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->personal_photo->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_personal_photo"] == "0") { ?>
<input type="hidden" name="fa_x_personal_photo" id= "fa_x_personal_photo" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_personal_photo" id= "fa_x_personal_photo" value="1">
<?php } ?>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_gender" class="form-group">
		<label id="elh_users_gender" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->gender->FldCaption() ?></label>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_blood_type" class="form-group">
		<label id="elh_users_blood_type" for="x_blood_type" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->blood_type->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->blood_type->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_driving_licence" class="form-group">
		<label id="elh_users_driving_licence" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->driving_licence->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->driving_licence->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_job" class="form-group">
		<label id="elh_users_job" for="x_job" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->job->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->job->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_volunteering_type" class="form-group">
		<label id="elh_users_volunteering_type" for="x_volunteering_type" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->volunteering_type->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->volunteering_type->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_marital_status" class="form-group">
		<label id="elh_users_marital_status" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->marital_status->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->marital_status->CellAttributes() ?>>
...
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_usersedit2" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($users->nationality_type->Visible) { // nationality_type ?>
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_nationality_type" class="form-group">
		<label id="elh_users_nationality_type" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nationality_type->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nationality_type->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_unid" class="form-group">
		<label id="elh_users_unid" for="x_unid" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->unid->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->unid->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_visa_expiry_date" class="form-group">
		<label id="elh_users_visa_expiry_date" for="x_visa_expiry_date" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->visa_expiry_date->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->visa_expiry_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fusersedit", "x_visa_expiry_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_visa_copy" class="form-group">
		<label id="elh_users_visa_copy" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->visa_copy->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->visa_copy->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_current_emirate" class="form-group">
		<label id="elh_users_current_emirate" for="x_current_emirate" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->current_emirate->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->current_emirate->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_full_address" class="form-group">
		<label id="elh_users_full_address" for="x_full_address" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->full_address->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->full_address->CellAttributes() ?>>
...
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_usersedit3" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($users->emirates_id_number->Visible) { // emirates_id_number ?>
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_emirates_id_number" class="form-group">
		<label id="elh_users_emirates_id_number" for="x_emirates_id_number" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->emirates_id_number->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->emirates_id_number->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_eid_expiry_date" class="form-group">
		<label id="elh_users_eid_expiry_date" for="x_eid_expiry_date" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->eid_expiry_date->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->eid_expiry_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fusersedit", "x_eid_expiry_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_emirates_id_copy" class="form-group">
		<label id="elh_users_emirates_id_copy" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->emirates_id_copy->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->emirates_id_copy->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_passport_number" class="form-group">
		<label id="elh_users_passport_number" for="x_passport_number" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->passport_number->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->passport_number->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_passport_ex_date" class="form-group">
		<label id="elh_users_passport_ex_date" for="x_passport_ex_date" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->passport_ex_date->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->passport_ex_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fusersedit", "x_passport_ex_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_passport_copy" class="form-group">
		<label id="elh_users_passport_copy" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->passport_copy->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->passport_copy->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $users_edit->MultiPages->PageStyle("4") ?>" id="tab_users4"><!-- multi-page .tab-pane -->
<?php if ($users_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_usersedit4" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($users->place_of_work->Visible) { // place_of_work ?>
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_place_of_work" class="form-group">
		<label id="elh_users_place_of_work" for="x_place_of_work" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->place_of_work->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->place_of_work->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_qualifications" class="form-group">
		<label id="elh_users_qualifications" for="x_qualifications" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->qualifications->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->qualifications->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_cv" class="form-group">
		<label id="elh_users_cv" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->cv->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->cv->CellAttributes() ?>>
<span id="el_users_cv">
<div id="fd_x_cv">
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_home_phone" class="form-group">
		<label id="elh_users_home_phone" for="x_home_phone" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->home_phone->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->home_phone->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_work_phone" class="form-group">
		<label id="elh_users_work_phone" for="x_work_phone" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->work_phone->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->work_phone->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_mobile_phone" class="form-group">
		<label id="elh_users_mobile_phone" for="x_mobile_phone" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->mobile_phone->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->mobile_phone->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_fax" class="form-group">
		<label id="elh_users_fax" for="x_fax" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->fax->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->fax->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_pobbox" class="form-group">
		<label id="elh_users_pobbox" for="x_pobbox" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->pobbox->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->pobbox->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $users_edit->MultiPages->PageStyle("5") ?>" id="tab_users5"><!-- multi-page .tab-pane -->
<?php if ($users_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_usersedit5" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_total_voluntary_hours" class="form-group">
		<label id="elh_users_total_voluntary_hours" for="x_total_voluntary_hours" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->total_voluntary_hours->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->total_voluntary_hours->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_overall_evaluation" class="form-group">
		<label id="elh_users_overall_evaluation" for="x_overall_evaluation" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->overall_evaluation->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->overall_evaluation->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $users_edit->MultiPages->PageStyle("6") ?>" id="tab_users6"><!-- multi-page .tab-pane -->
<?php if ($users_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_usersedit6" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($users->admin_approval->Visible) { // admin_approval ?>
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_admin_approval" class="form-group">
		<label id="elh_users_admin_approval" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->admin_approval->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->admin_approval->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_admin_comment" class="form-group">
		<label id="elh_users_admin_comment" for="x_admin_comment" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->admin_comment->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->admin_comment->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $users_edit->MultiPages->PageStyle("7") ?>" id="tab_users7"><!-- multi-page .tab-pane -->
<?php if ($users_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_usersedit7" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($users->security_approval->Visible) { // security_approval ?>
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_security_approval" class="form-group">
		<label id="elh_users_security_approval" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->security_approval->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->security_approval->CellAttributes() ?>>
...
<?php if ($users_edit->IsMobileOrModal) { ?>
	<div id="r_security_comment" class="form-group">
		<label id="elh_users_security_comment" for="x_security_comment" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->security_comment->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->security_comment->CellAttributes() ?>>
...
<?php
	if (in_array("user_attachments", explode(",", $users->getCurrentDetailTable())) && $user_attachments->DetailEdit) {
?>
